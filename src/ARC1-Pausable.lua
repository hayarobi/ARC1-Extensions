...
function addPauser(account)
  ...
  assert(system.getSender() == system.getCreator(), "ARC1: only contract owner can grant pauser role")
...
function renouncePauser()
  ...
  assert(sender ~= system.getCreator(), "ARC1: owner can't renounce pauser role")
